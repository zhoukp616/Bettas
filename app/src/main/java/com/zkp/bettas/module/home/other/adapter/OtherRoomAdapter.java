 ...
 * @description:
 */
public class OtherRoomAdapter extends RecyclerView.Adapter<OtherRoomAdapter.ViewHolder> {

    private Context context;
    private List<OtherBean.DataBean.RoomListBean> roomListBeanList;

    private OnItemClickListener onItemClickListener;

    public OtherRoomAdapter(Context context, List<OtherBean.DataBean.RoomListBean> roomListBeanList) {
    ...
    private OtherBean.DataBean.RoomListBean getItem(int position) {
