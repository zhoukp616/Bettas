 ...
 * @description:
 */
public class ThreeCateAllAdapter extends RecyclerView.Adapter<ThreeCateAllAdapter.ViewHolder> {

    private Context context;
    private List<AllBean.DataBean> cateTypeList;

    private OnItemClickListener onItemClickListener;

    public ThreeCateAllAdapter(Context context, List<AllBean.DataBean> cateTypeList) {
    ...
    public AllBean.DataBean getItem(int position) {
