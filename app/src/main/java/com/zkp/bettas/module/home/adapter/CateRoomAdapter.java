 ...
 * @description:
 */
public class CateRoomAdapter extends RecyclerView.Adapter<CateRoomAdapter.ViewHolder> {

    private Context context;
    private List<CateTypeBean.DataBean.RoomListBean> roomListBeanList;

    private OnItemClickListener onItemClickListener;

    public CateRoomAdapter(Context context, List<CateTypeBean.DataBean.RoomListBean> roomListBeanList) {
        this.context = context;
        this.roomListBeanList = roomListBeanList;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvOnlineNum.setText(getOnLine(Integer.parseInt(getItem(position).getOnline())));
    ...
    public int getItemCount() {
        return roomListBeanList.size();
    }

    private CateTypeBean.DataBean.RoomListBean getItem(int position) {
        return roomListBeanList.get(position);
    }
